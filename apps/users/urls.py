...
from apps.users.views import RegisterAPIView, LoginAPIView, VerifyOtpAPIview, ChangePasswordAPIView, \
    ResetPasswordSendEmailAPIView, PasswordTokenCode, PasswordResetNewPassword, ResendConfirmationEmailAPIView

urlpatterns = [
    path('register/', RegisterAPIView.as_view(), name='register'),
    path('resend-confirmation-email/', ResendConfirmationEmailAPIView.as_view(), name='resend_confirmation_email'),
